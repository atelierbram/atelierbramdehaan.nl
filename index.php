...
<main class="main container">
  <article class="article article-intro">
    ...
    <div class="article_en nl-hidden" lang="en" id="articleEN">
      ...
      <p class="article-intro_text">Questions that will also have to be answered through the faithful elaboration of the design – web construction (web development). Because web building is a craft with HTML, CSS and JavaScript as basic&nbsp;tools.</p>
