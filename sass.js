...
var configs = {
  name: 'abh',
  files: ['style.scss','critical.scss','local.scss','frontpage.scss','colorscheme/demo-monochrome-palette-24-hues.scss','colorscheme/demo-master-palette-24-hues.scss','colorscheme/demo.scss','colorscheme/index.scss'],
  pathIn: 'src/assets/sass',
  pathOut: 'docs/assets/css',
  indentType: 'spaces',
  indentWidth: 2,
  minify: true,
  sourceMap: true
