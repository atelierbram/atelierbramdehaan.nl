...
<main class="main container">
  <article class="article article-intro">
    <h2 class="article-intro_title f5 f4-ns f5-m serif"><?= $title; ?></h2>
    <p class="article-intro_text">Webdesign is een vorm van toegepaste kunst dat in dienst staat van de gebruikservaring van de bezoeker: de essentie van de website hoort voor de bezoeker z.s.m. ondubbelzinnig duidelijk te&nbsp;zijn.</p><h3 class="f5 f4-ns f5-m serif">Ontwerp</h3><p>Vragen die door het ontwerp beantwoord zullen moeten&nbsp;worden:</p>
    ...
    <h3 class="f5 f4-ns f5-m serif">Uitwerking</h3>
    ...
    <h3 class="f5 f4-ns f5-m serif">Optimalisatie</h3>
    ...
    <div class="cta mt8 mb10"><h3 class="cta_header f5 f4-ns f5-m serif">Wilt U ook een website toegesneden op&nbsp;maat van uw&nbsp;organisatie?</h3><p class="cta_text article-intro_text mt6">Neem <a href="../contact">contact</a> met mij op voor een&nbsp;kennismakingsgesprek.</p></div>
