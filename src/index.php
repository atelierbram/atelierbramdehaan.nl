...
?>
  <main class="main mt8 container">
   ...
   <p class="article-intro_text mt8">Vragen ook die door de getrouwe uitwerking van het ontwerp –  web-bouw (web-development) –  beantwoord zullen moeten worden. Want web-bouw is een ambacht met als elementair gereedschap HTML, CSS en JavaScript. Atelier Bram de Haan begint bij het bouwen van een website iedere keer weer met een leeg canvas: ik stel eer in een semantische HTML-markup met effectieve stijlen, z.v.m. gebruikmakend van “vanilla javaScript”, en zo weinig mogelijk gebruikmakend van zgn. “frameworks”. Een website optimaliseren zodat het snel laadt –  is een sport die vanaf het allereerste begin van web-bouw in het achterhoofd zit, want een goed presterende snelle website is een essentiële kwaliteit voor de gebruikservaring.</p><!-- <p><a href="./webdesign/">Voorbeelden van websites</a> door Atelier Bram de Haan.</p> -->
<div class="cta mt8"><h3 class="cta_header">Wilt U ook een website op maat voor uw specifieke doelgroep?</h3><p class="cta_text article-intro_text mt8">Neem <a href="../contact">contact</a> met mij op voor een kennismakingsgesprek.</p></div>
    </article>
  </main>
