...
$type = 'project-page';
$id = 'schilderijen';
$description = 'schilderij - Baviaan-Auto door Bram de Haan';
...
?><div class="gallery_module mt8">
  <div class="gallery_module_media gallery_module_media-painting"><img data-src="<?= $assetPath ?>img/pics/paintings/baviaan-auto_Bram-de-Haan_720x570.jpg" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 432 342'%3E%3Crect width='432' height='342' fill='%23b5b0a6'/%3E%3C/svg%3E" alt="<?= $imageDescription; ?>" width="432" height="342" class="gallery_module_image-painting"></div>
