<?php
$title = 'Slang-Glijbaan';
$type = 'project-page';
$id = 'schilderijen';
$description = 'schilderij - slang glijbaan door Bram de Haan';
...
?><div class="gallery_module mt8">
  <div class="gallery_module_media gallery_module_media-painting"><img data-src="<?= $assetPath ?>img/pics/paintings/slang-glijbaan_Bram-de-Haan_570x720.jpg" src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 432 546'%3E%3Crect width='432' height='546' fill='%23b5b0a6'/%3E%3C/svg%3E" alt="<?= $imageDescription; ?>" width="432" height="546" class="gallery_module_image-painting"></div>
